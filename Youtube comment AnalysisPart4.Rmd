...
videos_year <- yt_search("Comedy", published_after = "2018-6-01T00:00:00Z", published_before = "2019-1-1T00:00:00Z")
...
videos_year <- yt_search("Socker", published_after = "2017-6-01T00:00:00Z", published_before = "2020-1-1T00:00:00Z")
# fetching video statistics for all videos (2018-2019)
videostats = lapply(as.character(videos_year$video_id), function(x){
  get_stats(video_id = x)
})
...
# correcting data type
videos_year[,c('viewCount', 'likeCount', 'dislikeCount', 'favoriteCount', 'commentCount')]=apply(videos_year[,c('viewCount', 'likeCount', 'dislikeCount', 'favoriteCount', 'commentCount')],2,as.numeric)
 write.csv(videos_year,'socker_2017-2020.csv', row.names = FALSE)
```
...
yt_oauth(app_id = app_id, app_secret = app_secret)
videos_year <- yt_search("Marvel", published_after = "2017-6-01T00:00:00Z", published_before = "2020-1-1T00:00:00Z")
# fetching video statistics for all videos (2018-2019)
videostats = lapply(as.character(videos_year$video_id), function(x){
  get_stats(video_id = x)
})
...
# correcting data type
videos_year[,c('viewCount', 'likeCount', 'dislikeCount', 'favoriteCount', 'commentCount')]=apply(videos_year[,c('viewCount', 'likeCount', 'dislikeCount', 'favoriteCount', 'commentCount')],2,as.numeric)
 write.csv(videos_year,'marvel_2017-2020.csv', row.names = FALSE)
```
```{r}

videos_year <- yt_search("movies", published_after = "2017-6-01T00:00:00Z", published_before = "2018-1-1T00:00:00Z")
...
# correcting data type
videos_year[,c('viewCount', 'likeCount', 'dislikeCount', 'favoriteCount', 'commentCount')]=apply(videos_year[,c('viewCount', 'likeCount', 'dislikeCount', 'favoriteCount', 'commentCount')],2,as.numeric)
 write.csv(videos_year,'movies_2017-2018.csv', row.names = FALSE)
```
