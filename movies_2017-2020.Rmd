...
```{r}
movies2017 = read.csv('movies_2017-2018.csv')
 movies2018 = read.csv('movies_2018-2019.csv')
 movies2019 = read.csv('movies_2019-2020.csv')
movies2020 = read.csv('movies_2020.csv')
movies2016 = read.csv('movies_2016.csv')
movies2014 = read.csv('movies2014.csv')
movies2015 = read.csv('movies_2015.csv')
travel = read.csv('travel.csv')
socker = read.csv('socker_2017-2020.csv')
travel$month<- NULL
travel$year<- NULL



mov=rbind(movies2017,movies2018,movies2019,movies2016,  movies2017,movies2019,movies2020,movies2015)
#mov=rbind(movies2020,movies2014,movies2016)
#write.csv(mov,'moviesAll.csv', row.names = FALSE)
```
