...
videos_year <- yt_search("music", published_after = "2019-1-01T00:00:00Z", published_before = "2020-1-1T00:00:00Z")
...
write.csv(videos_year,'music2019.csv', row.names = FALSE)
```
```{r}
library(ggplot2)
